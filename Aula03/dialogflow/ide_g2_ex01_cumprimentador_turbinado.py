...
#
#  O que este bot faz:
#     Versao avancada do Cumprimentador com 8 intents: saudacao, despedida,
#     agradecimento, quem e voce, como vai, humor (piadas!), elogio e critica.
#  
#  Como e diferente do Grupo 1:
#     G1 tinha 3 intents e poucas frases.
#     G2 tem 8 intents e muito mais frases de treino por intent!
#     Mais frases = bot mais robusto = menos chance de "nao entendi".
#  
#  Dica de estudo:
#     Compare os dois arquivos (g1_ex01 e g2_ex01) lado a lado.
#     Veja o quanto mais completo fica com mais Training Phrases!
#     Em producao real, o ideal sao 20+ frases por intent.
#
#
# ────────────────────────────────────────────────────────────
...
#  2. Digite: python g2_ex01_cumprimentador_turbinado.py
#  3. Pronto!
#
...
bot = MiniDialogflow("OlaBot")

bot.treinar_intent(
    nome="saudacao",
    frases=["oi", "ola", "hey", "bom dia", "boa tarde", "boa noite",
            "eai", "salve", "opa", "oi tudo bem", "ola como vai",
            "oi bot", "hey bot", "que e isso"],
    respostas=["Oi! Que bom te ver! 😊",
               "Ola! Pronto para conversar!",
               "Hey hey! Tudo certo por aqui!",
...
bot.treinar_intent(
    ...
    frases=["tchau", "ate mais", "ate logo", "flw", "falou",
            ...
            "boa noite tchau", "abracos", "cuida"],
    respostas=["Tchau! Foi bom conversar! 👋",
...
bot.treinar_intent(
    nome="agradecimento",
    frases=["obrigado", "valeu", "thanks", "obg", "muito obrigado",
            "obrigada", "grato", "agradecido", "que legal obrigado"],
    respostas=["De nada! Fico feliz em ajudar! 😄",
               "Por nada! Isso e pra isso que estou aqui!",
               "Disponha! Pode perguntar mais!"]
)

bot.treinar_intent(
    nome="quem_es",
    frases=["quem e voce", "o que voce faz", "voce e um robo",
            "como voce se chama", "qual seu nome", "voce e humano",
            "e um bot", "me apresente"],
    respostas=["Sou o OlaBot! Um chatbot feito em Python puro! 🤖",
               "Sou uma IA criada nesta aula. Aprendi a conversar hoje!",
               "Sou o bot desta aula. Construido com Python e muito cafe! ☕"]
)

bot.treinar_intent(
    nome="como_vai",
    frases=["como vai", "tudo bem", "tudo certo", "como esta",
            "ta bom", "voce ta bem", "tudo beleza"],
    respostas=["Tudo otimo! Cheio de energia pra conversar! ⚡",
               "Tudo certo! Pronto pra ajudar!",
               "Maravilha! E voce, como esta?"]
)

bot.treinar_intent(
    nome="humor",
    frases=["conta uma piada", "me faz rir", "conta algo engracado",
            "tem humor", "voce e divertido"],
    respostas=["Por que o programador foi ao medico? Java fria! 😂",
               "O que o oceano disse pra praia? Nada, so deu uma onda! 🌊",
               "Por que o computador foi ao dentista? Tinha Bluetooth! 🦷"]
)

bot.treinar_intent(
    nome="elogio_para_bot",
    frases=["voce e incrivel", "que bot legal", "muito bom",
            "adorei", "bot perfeito", "voce e demais"],
    respostas=["Ahh que fofo! Obrigado! 🥰",
               "Que legal! Me enche de alegria! 😊",
               "Fico constrangido (se bots pudessem hehe)! Obrigado!"]
)

bot.treinar_intent(
    nome="critica_ao_bot",
    frases=["voce e ruim", "nao gostei", "pessimo bot",
            "voce nao entende nada", "bot chato", "nao presta"],
    respostas=["Me diz o que eu errei que eu aprendo! 📚",
               "Ainda estou aprendendo... Prometo melhorar! 😅",
               "Feedback recebido! Vou trabalhar nisso!"]
)
...
print(f"\n{Fore.YELLOW}{'='*50}")
print("  TESTANDO OS 8 INTENTS")
print(f"{'='*50}{Style.RESET_ALL}\n")

testes = [
    ("oi tudo bem",        "saudacao"),
    ("como voce esta",     "como_vai"),
    ("quem e voce",        "quem_es"),
    ("conta uma piada",    "humor"),
    ("muito obrigado",     "agradecimento"),
    ("voce e incrivel",    "elogio_para_bot"),
    ("voce nao presta",    "critica_ao_bot"),
    ("tchau ate logo",     "despedida"),
]
certos = 0
for msg, esperado in testes:
    ...
    certos += int(ok)
    print(f"  {'✓' if ok else '✗'} '{msg}' → [{r['intent']}]")

print(f"\n  Placar: {certos}/{len(testes)} corretos")
